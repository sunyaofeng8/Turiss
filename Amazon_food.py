...
"""
"""
train_df = train_df[(train_df['HelpfulnessDenominator']>3) & (train_df['HelpfulnessDenominator']<20)]
train_df["Usefulness"] = (train_df["HelpfulnessNumerator"]/train_df["HelpfulnessDenominator"]).apply\
