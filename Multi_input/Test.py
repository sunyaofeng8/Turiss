...
multi_input = MultiInput(trainset, testset, save=True, load=False, name1='newdic_product', name2='newdic_user', \
                   name3='newdic_time', name4='newdic_help_nume', name5='newdic_help_deno')
